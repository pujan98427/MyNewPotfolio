...
export function AdSlot({slot,format="auto"}:{slot:string;format?:"auto"|"fluid"|"rectangle"}){
  ...
  return <ins className="adsbygoogle adsense-inventory" data-ad-client={adsenseClient} data-ad-slot={slot} data-ad-format={format} data-full-width-responsive="true"/>;
}
