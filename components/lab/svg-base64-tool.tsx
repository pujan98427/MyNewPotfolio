...
export function SvgBase64Tool(){
  ...
  return <section className="svg-converter" aria-labelledby="svg-converter-heading">
    ...
    <aside className="svg-local-privacy" aria-label="SVG conversion privacy and access"><strong>Private and open.</strong><div><p>Your SVG is processed locally in your browser and is not uploaded to our server.</p><p>No account, signup, email, API key or payment required. Paste an SVG and start immediately.</p></div></aside>
