...
export function SvgBase64Tool(){
  ...
  return <section className="svg-converter" aria-labelledby="svg-converter-heading">
    ...
    <aside className="svg-local-privacy" aria-label="SVG conversion privacy and access"><strong>Private by default</strong><div><p>This file is processed on your device. It is not uploaded to my server.</p><p>No account, signup, email, API key or payment required. Paste an SVG and start immediately.</p></div></aside>
