...
export function ToolEducation({content}:{content:ToolEducationContent}){return <section className="tool-education" id="documentation" aria-labelledby={`${content.slug}-education-heading`}>
