...
export async function GET(request:NextRequest){
  ...
  return new ImageResponse(<div style={{display:"flex",position:"relative",width:"100%",height:"100%",padding:"70px 78px",overflow:"hidden",background:"#f0eee8",color:"#151515",fontFamily:"Arial, sans-serif"}}>
    <div style={{display:"flex",position:"absolute",right:"-90px",top:"-140px",width:"520px",height:"520px",borderRadius:"50%",background:"#ff5c35",opacity:.92}} />
    ...
    <div style={{display:"flex",flexDirection:"column",justifyContent:"space-between",width:"100%",height:"100%",zIndex:1}}>
