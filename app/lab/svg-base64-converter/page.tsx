...
export const metadata=createPageMetadata({title:"SVG to Base64 Converter — Encode & Decode SVG Online",description:"Convert SVG markup to Base64 or decode an SVG Base64 data URI locally in your browser. Unicode-safe, private, free, and ready to copy.",path:"/lab/svg-base64-converter",absoluteTitle:true,imageAlt:"SVG to Base64 converter for encoding and decoding SVG markup"});
