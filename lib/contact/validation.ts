...
export const CONTACT_TOPICS=["website","job","collaboration","other"] as const;
export type ContactTopic=typeof CONTACT_TOPICS[number];
export type ContactInput={email:string;message:string;topic?:string;website?:string;turnstileToken?:string;requestId?:string;completionTimeMs?:number};
